...
Marker = react.createFactory (require 'google-maps-react').default
...
class SimpleMapPage extends react.Component
  ...
  render: ~>
    ...
    Map {className: 'map', google: @props.google, zoom: 14, centerAroundCurrentLocation: true},[
      Marker {key: 1, name: 'hello', position: {lat: 37.778519, lng: -122.405640}}
    ]
module.exports = 
  GoogleApiWrapper({
